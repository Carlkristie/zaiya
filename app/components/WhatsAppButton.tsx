...
export default function WhatsAppButton() {
  ...
  const message = encodeURIComponent("Hi ZAIYA, I'd like to learn more about your services.");
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-[0_0_20px_rgba(37,211,102,0.4)]"
      style={{
        opacity: visible ? 1 : 0,
